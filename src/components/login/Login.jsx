...
// import img from "https://images.unsplash.com/photo-1546514714-df0ccc50d7bf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=667&q=80"
...
function Login() {
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <p className='mb-4 text-center font-normal md:mb-8 sm:text-center'>Silahkan login menggunakan akun admin</p>
...
<div class="mt-20 py-16">
    <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        ...
        <div class="w-full p-8 lg:w-1/2">
            <h2 class="text-2xl font-semibold text-gray-700 text-center">MySemedo</h2>
