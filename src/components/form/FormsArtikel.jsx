...
export default function FormArtikel () {
    ...
    <div class="mb-10 md:mb-16">
      <h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Tambah Data Artikel</h2>
    </div>
    {/* <!-- text - end --> */}
    ...
    <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2">
      <div class="sm:col-span-2">
        <label for="subject" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Judul Artikel</label>
      ...
      <div class="sm:col-span-2">
        <label for="message" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">Isi Artikel</label>
